"""
SGW CDR Field Definitions
==========================
Defines input fields (from ASN.1 BER decoding), output fields (for SGWRecord model),
field mappings, validation rules, and enrichment rules for SGW CDR processing.

SGW-CDR records (record type 78) are decoded by PGWDecoder from the same
binary Huawei CDR format as PGW CDRs.

Based on 3GPP TS 32.298 SGW-CDR field specifications.
"""


# =============================================================================
# SECTION 1: INPUT_FIELDS
# Raw fields from PGW/SGW ASN.1 BER CDR as decoded by PGWDecoder.
# =============================================================================

INPUT_FIELDS = {
    'record_type': {
        'tag': 0x80, 'type': 'integer',
        'description': 'CDR record type identifier (78=SGW-CDR)',
    },
    'served_imsi': {
        'tag': 0x83, 'type': 'tbcd',
    ...
    'charging_id': {
        ...
        'description': 'Charging ID assigned by the SGW for this bearer',
    },
    'apn': {
    ...
    'node_id': {
        ...
        'description': 'Node ID in string form (SGW hostname or identifier)',
    },
    'served_msisdn': {
        'tag': 0x96, 'type': 'tbcd',
...
# Standardized output fields mapped to SGWRecord model columns.
# =============================================================================

OUTPUT_FIELDS = {
    'record_type': {
        'type': 'string', 'max_length': 20,
        'description': 'Record type name (SGW-CDR)',
    },
    'service_type': {
        'type': 'string', 'max_length': 10, 'default': 'DATA',
        'description': 'Always DATA for SGW records',
    },
    'calling_number': {
        'type': 'string', 'max_length': 20,
    ...
    'charging_id': {
        'type': 'bigint',
        'description': 'SGW charging identifier',
    },
}
...
# Maps SGW decoder output field names -> SGWRecord field names.
# =============================================================================
...
ENRICHMENT_RULES = {
    'service_type': {
        ...
        'default': 'DATA',
        'condition': 'if_empty',
        'description': 'SGW records are always DATA',
    },
    'calling_number': {
        'transform': 'copy',
        'source_field': 'msisdn',
